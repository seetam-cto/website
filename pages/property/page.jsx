        ...
        <div className="property-gallery-slider">
            <Row gutter={[10,0]}>
                <Col style={{paddingTop: 10}} span={12}>
                    <AntImage className='property-gallery-main nomar' src={imageList.filter((p) => p !== null)[0]} alt='' />
                </Col>
                <Col style={{padding: 10}} span={12}>
                    <Row gutter={10}>
                        <Col style={{padding: 5}} span={12}>
                            <AntImage className='property-gallery-sides' src={imageList.filter((p) => p !== null)[1]} alt="" />
                            <AntImage className='property-gallery-sides' src={imageList.filter((p) => p !== null)[2]} alt="" />
                        </Col>
                        <Col style={{padding: 5}} span={12}>
                                <AntImage className='property-gallery-sides' src={imageList.filter((p) => p !== null)[3]} alt="" />
                                <div className="view-more">
                                    <img className='property-gallery-sides overlay' src={imageList.filter((p) => p !== null)[4]} alt="" />
            ...
            <AntImage.PreviewGroup preview={{visible, onVisibleChange: (value) => setVisible(value)}}>
                {imageList.filter((p) => p !== null).slice(4,20).map((ig, i) => 
...
const GalleryMobile = ({imageList}) => {
    ...
    return (
        <Slider {...settings.for2}>
            {imageList && imageList.filter((p) => p !== null).map((image,i) => (
            ...
            <AnimatePresence>
                ...
                <div className="property-desktop property-banner">
                    <div className="property-banner-background">
                        <Image className='image' src={property?.main?.gallery?.photos.filter((p) => p !== null)[0]} width={1600} height={900} />
                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-6 property-banner-image">
                                <Image src={property?.main?.gallery?.photos.filter((p) => p !== null)[1]} width={1600} height={900}/>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="property-desktop container">
                    <div className="row">
                        <div className="col-8">
                            <Gallery imageList={property?.main?.gallery?.photos.filter((p) => p !== null)} />
                        </div>
                        <div className="col-4">
